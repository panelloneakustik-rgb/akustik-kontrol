...
export default function Footer() {
  return (
    <footer className="mt-16 border-t border-ink/10 bg-cream">
      <div className="px-8 py-10 flex flex-wrap items-center justify-between gap-8 max-w-6xl mx-auto">
        ...
        <div className="text-sm text-ink/70 flex flex-col gap-1 items-start md:items-end">
      ...
      <div className="border-t border-ink/10 px-8 py-4 flex flex-wrap items-center justify-between gap-4 max-w-6xl mx-auto text-xs text-ink/50">
